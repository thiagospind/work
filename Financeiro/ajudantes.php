...
$mensalidade = array(
    'caixa_inicial' => (isset($_POST['caixa_inicial'])) ? $_POST['caixa_inicial'] : '',
    'mensalidades' => (isset($_POST['nome'])) ? $_POST['nome'] : '',
    'procedimentos'  => (isset($_POST['situacao'])) ? $_POST['situacao'] : '',
    'dinheiro'  => (isset($_POST['dt_nascimento'])) ? $_POST['dt_nascimento'] : '',
    'cheque'  => (isset($_POST['sexo'])) ? traduz_sexo($_POST['sexo']) : '',
    'cartao' => (isset($_POST['identidade'])) ? $_POST['identidade'] : '',
    'total'  => (isset($_POST['org_exp'])) ? $_POST['org_exp'] : ''
);
