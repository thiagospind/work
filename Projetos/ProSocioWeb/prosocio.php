        ...
        <div class="container">
            <div class="divAssociados">
                ...
                foreach ($associados as $associado) {
                    $destino = realpath(($_SERVER['DOCUMENT_ROOT'])) . "\\FotosSocios\\" . $associado['cpf'] . ".jpg";
                ...
                <button class="collapsible" type="button">&nbsp;Dados do Associado</button>
                    <div class="content">
                        ...
                        <div class="divLinha">
                            <div class="fotoSocio">
                                <img height="158px" width="118px" src="<?php echo "/ProSocioWeb/FotosSocios/".$associado['cpf'] . ".jpg"; ?>">
                            </div>
                            <div class="divColuna">
                                <div class="divLinha">
